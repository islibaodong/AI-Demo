...
| 目录 | 说明 |
|------|------|
| [`spring-ai-demo/`](spring-ai-demo/) | **Spring AI 学习实验室**：26 节课由浅入深（基础调用 → RAG/Advisor/MCP/多模态 → 生产实战：健壮性/安全/可观测/输出修复 → 业务实战：Agent 编排/RAG 进阶/评估/Capstone → 企业级：多用户权限/工作流编排与人在环中/企业级 Agent 整合），每课一个 `@RestController`，可独立 curl 体验，中文注释并标注与 Python LangChain 的概念对照。**详细文档见 [`spring-ai-demo/README.md`](spring-ai-demo/README.md)**。 |
...
# 离线构建 + 跑全部测试（26 个测试类 / 135 个用例，不需要 API Key）
mvn clean package
